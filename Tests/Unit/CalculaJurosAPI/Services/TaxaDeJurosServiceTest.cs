...
namespace Tests.Unit.CalculaJurosAPI.Services
{
    public class TaxaDeJurosServiceTest
    {
        ...
        public async Task TaxaDeJurosService_DeveRetornarTaxa()
        {
            ...
            var loggerMock = new Mock<ILogger<TaxaDeJurosService>>();

            // Act  
            var service = new TaxaDeJurosService(httpClientFactory.Object, loggerMock.Object);
